...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="10to50_curved_optimization")

hits_data, track_params_data, track_classes_data = load_curved_3d_data(data_path="hits_and_tracks_3d_10to50curved_events_all.csv", max_num_hits=1350) #540
