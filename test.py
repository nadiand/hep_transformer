...
from trackml_data import load_trackml_data, load_gnnlike_trackml_data
...
checkpoint = torch.load("models/50to100_trackml_best", map_location=torch.device('cpu'))
...
for cl_size in [5]: #2, 3, 4, 5, 6, 7, 8, 9]:
    for min_sam in [2]: #, 3, 4, 5, 6, 7, 8, 9]:
        ...
        # if min_sam == 5 and cl_size == 2:
        #     preds = list(preds.values())
        #     for param in ["theta", "phi", "q"]:
        #         plot_heatmap(preds, param, "50to100tracks")