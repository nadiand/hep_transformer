...
from training import predict_with_refined_clusters
...
hits_data, track_params_data, track_classes_data = load_trackml_data(data="trackml_data_50tracks.csv", normalize=True, chunking=False)
