...
x = torch.Tensor([np.array([[-150.2,-201.7,-230.6],[-127.9,-302.3,-219.1],[-172.0,-310.1,-270.8]])]) #, np.array([[-49.4727,-58.4256,-1298.0],[-41.6409,-49.6406,-1098.0],[-41.6409,-49.6406,-1098.0]])])
